        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{route('gold.store')}}" method="POST">
                ...
                <div class="flex items-center justify-center px-4 py-3 text-center sm:px-6">
                    ...
                    <button class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:shadow-outline-gray disabled:opacity-25 transition ease-in-out duration-150" onclick="window.location.href='{{ route('gold.index') }}'">
                        Cancel
                    </button>
